...
- Créer quelques tests unitaires pour s'assurer du comportement de base
- Renommage de variables
- Découpage en plus petites méthodes de la logique
- Séparation des responsabilités avec création d'un ShoppingService

## Refactoring to continue

- Meilleure gestion des erreurs
- Mettre des logs
- Plus de tests et notamment les nouvelles méthodes créées
- Injecter la date différement pour que ce soit plus testable
- Refaire une passe sur le nommage des variables et méthodes
